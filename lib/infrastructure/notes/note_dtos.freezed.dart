...
class _$TodoItemDtoTearOff {
  ...
  _TodoItemDto call({String? id, String? name, bool? done}) {
    return _TodoItemDto(
      id: id,
      name: name,
      done: done,
...
class _$_TodoItemDto extends _TodoItemDto {
  const _$_TodoItemDto({this.id, this.name, this.done}) : super._();
...
abstract class _TodoItemDto extends TodoItemDto {
  const factory _TodoItemDto({String? id, String? name, bool? done}) =
      _$_TodoItemDto;
